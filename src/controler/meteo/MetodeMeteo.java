...
//                mp.setCloudsValue(jo.getJsonObject("clouds").getInt("all"));
    ...
    public static void prikaziMeteoPodatke(JPanel panelDanas, JPanel panelPrognoza, List<MeteoPodaci> listaMeteoPodataka){
        ...
        panelDanas.add(new JLabel(
                "<html>Trenutno: " + mp.getWeatherValue() + "<br/>"+
                ...
                "Zalazak sunca: " + formatterSat.format(mp.getSunSet()) + "</html>"), gridDanas);
        ...
        for (MeteoPodaci meteoPodaci : listaMeteoPodataka) {
            if(meteoPodaci != listaMeteoPodataka.get(0)){
                ...
                panelPrognoza.add(new JLabel("<html>" + formatterDatum.format(meteoPodaci.getSunRise()) + "</html>"), gridPrognoza);
                ...
                panelPrognoza.add(new JLabel(
                    "<html>Min: " + meteoPodaci.getTemperatureMin().toString()  + " " + mp.getTemperatureUnit() + "<br/>" +  
                    "Max: " + meteoPodaci.getTemperatureMax().toString() + " " + mp.getTemperatureUnit() + "</html>"), gridPrognoza);
                gridxIkonaTekst++;
            }
